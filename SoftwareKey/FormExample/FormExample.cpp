...
// FormExample.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(TFormExampleApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание TFormExampleApp

TFormExampleApp::TFormExampleApp()
{
...
// Единственный объект TFormExampleApp

TFormExampleApp theApp;


// инициализация TFormExampleApp

BOOL TFormExampleApp::InitInstance()
{
